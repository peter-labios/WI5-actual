    ...
    <section id="indulge" class="container fullpage-bg">
        <div class="col-12 text-center">
            <div id="cc" class="animated  bounceInUp">
                <img src="<?= base_url();?>img/levelsheader.png" class="logo-img">
            </div>
            <div id="cc" class="animated bounceInUp">
                <img src="<?= base_url();?>img/levelsbody.png" class="logo-img">
            </div>
        </div>
        <div class="col-6">
            <a href="<?= base_url();?>Load/StageInstruction" class="btn" class="animated bounceOutUp"> Next</a>
